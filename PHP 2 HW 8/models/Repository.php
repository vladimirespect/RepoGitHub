...
abstract class Repository
{
    ...
    public static function getAllObjects()  //заккоментил пока не переделаем,  потому что в контроллере обрабатываем массивы а не объекты
    {
...
//$product->price = 150;
    ...
    public function deleteAnd($name, $value, $name2, $value2) {
        $tableName = $this->getTableName();
